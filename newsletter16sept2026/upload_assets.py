...
res_dir = r'c:\Users\Admin\Desktop\newsletter\newsletter16sept2026\resources_folder'
files = [f for f in os.listdir(res_dir) if f.lower().endswith(('.png', '.jpg', '.jpeg', '.svg')) and f != 'preview_thumb.png']
...
out_json = r'c:\Users\Admin\Desktop\newsletter\newsletter16sept2026\uploaded_urls.json'
